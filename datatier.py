...
#   Project 02
# Written by:
# Kenan Kamel A Alghythee(664753831)
# U. of Illionis, Chicago
# submmited 2/17/2022 Thurs
# Feb 2022
import sqlite3
...
def select_one_row(dbConn, sql, parameters = []):
  ...
  try:
    ...
    print("select_one_row failed:", error)
    return None
  finally:
    db_Cursor.close()
